...
export const getSideMenus = createAsyncThunk('auth/get/sidebar/menu', async (user) => {
  const response = await axios.get(`${process.env.REACT_APP_API_HOST}/auth/sidebar/menu?roleId=${user.roleId}`);
